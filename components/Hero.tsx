  ...
  return (
    <div className="flex p-4">
      <div className="relative flex flex-col-reverse md:flex-row lg:flex-row justify-center item-center  ">
        <div className="w-full md:w-1/2 lg:w-2/3 pt-0 md:pt-10 pb-20 md:pt-0 md:pb-0 lg:pt-0 lg:pb-0">
          <h1
            className="text-2xl md:text-3xl w-[300px]  m-auto md:w-auto lg:text-4xl xl:text-[35px] font-bold text-white  text-center md:text-left leading-tight "
            style={{
          ...
          {/* Mobile Disclaimer */}
          <div className="block md:hidden mb-8 mt-[-12px]">
            <p
              className="text-[#ABABAB] text-xs text-center w-[300px] font-medium mb-4 max-w-md mx-auto"
              style={{
                fontFamily: "var(--font-figtree)",
              }}
            >
          ...
          >
            GET STARTED
            <span className="ml-2">
              {/* <img src="./assets/arrow.png" alt="arrow point" /> */}
              <Image
